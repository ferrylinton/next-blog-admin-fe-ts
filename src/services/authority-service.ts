...
import { CreateAuthority, UpdateAuthority } from "@/validations/authority-schema";
...
export async function updateAuthority(id: string, data: UpdateAuthority, clientInfo: ClientInfo) {
    const headers = getHeaders(clientInfo);
