                    ...
                    <form
                        ...
                        <div className="form-group">
                            <div className='w-full bg-stone-200'>
                                <label htmlFor='file' className={`h-[50px] flex justify-center items-center gap-2 border cursor-pointer hover:bg-stone-300 ${validationErrors.file ? 'border-red-500' : 'border-stone-400'} appearance-none focus:outline-none focus:ring-4`}>
                                    <UploadIcon className='w-[24px] h-[24px]' />
                                    <span className="leading-none">{t('selectImage')}</span>
                                    <input
                                        type="file"
                                        id="file"
                                        accept="image/*"
                        ...
                        <div className='flex justify-center items-center w-full mt-1  p-2 border border-stone-400 bg-white'>
                            {
                                (selectedFile) ?
                                    ...
                                    (<div className='flex flex-col justify-center items-center my-6'>
                                        <ImageIcon className='w-[100px] h-[100px] text-stone-300' />
                                        <div className='text-center text-stone-400'>{t('noImage')}</div>
                                    </div>)
                            }
                        </div>
